...
{{--	<style>{!! File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>--}}
	...
	<style>
        ...
        #nav, #nav .dropdown-menu, .bg-main, .fab-wrapper .fab-button {
...
<body>
	<nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
		...
		{{-- <a class="navbar-toggler collapsed border-0 px-1 py-2 m-0">
			<input type="text" name="custom_search" id="custom_search" placeholder="Search"/>
		</a> --}}
		<form id="search-form" class="form-inline">
			<input type="text" name="keyword" id="keyword" placeholder="Search your file here..." class="form-control-sm mr-2">
			<button type="button" id="keyword-button" class="btn btn-sm btn-dark mr-2">Search</button>
			<button type="button" id="keyword-reset-button" class="btn btn-sm btn-outline-danger mr-2">Reset</button>
		</form>
